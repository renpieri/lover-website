...
import '../public/css/NuevoShow.css'
...
function NuevoShow(){
    ...
    function onSubmit(e){
        e.preventDefault()
        ShowsServices.cargarShow({dia, hora, lugar, ciudad, provincia, pais, precio})
            .then(()=>{
                navigate('/shows') 
            })
            .catch((err)=>{
    ...
    return( 
            <section className='section-form block p-6 rounded-lg shadow-lg m-5'>
                <h3 className='text-2xl mb-5 text-white'>CARGAR NUEVO SHOW</h3>
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className='flex flex-col mb-4'>
                        ...
                        <input className='p-1 border border-gray-300 rounded' type="text" name='lugar' id='lugar' onChange={cambiarLugar} value={lugar} placeholder='Lugar del evento'/>
                    </div>
